...
- Current release-prep baseline for `0.5.3`: 59 unit test files / 360 unit tests, 19 e2e files / 25 e2e tests, and `npm run release:check` green.
- Additional 2026-05-04 verification on OpenClaw 2026.5.3-1: plugin startup contracts, `openclaw-swarm-layer` doctor checks, and runtime health smoke passed on upgraded hosts.
