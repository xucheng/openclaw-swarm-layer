    ...
    const commandRunner = vi.fn(async () => ({
      ...
      stdout: JSON.stringify({
        result: {
          ...
          risks: ["bridge mode depends on internal aliases"],
          remediation: ["Pin bridge.versionAllow to the validated OpenClaw versions or a minimum compatible range."],
          nextAction: "Pin bridge.versionAllow to the validated OpenClaw versions or a minimum compatible range.",
          severity: "warning",
        },
      }),
      stderr: "",
